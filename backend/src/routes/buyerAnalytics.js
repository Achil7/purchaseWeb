 ...
 */
router.get('/accounts', authenticate, authorize(['admin']), ctrl.getAccounts);
 ...
 * @access  Private (Admin, Operator)
 */
router.get('/accounts/:accountNormalized/buyers', authenticate, authorize(['admin']), ctrl.getAccountBuyers);
