 ...
 * @access  Private
 */
router.get('/item/:itemId', buyerController.getBuyersByItem);
 ...
 */
router.post('/item/:itemId', buyerController.createBuyer);
 ...
 * @access  Private (Operator, Admin)
 */
router.post('/item/:itemId/parse', buyerController.parseBuyer);
 ...
 */
router.patch('/:id/payment', buyerController.confirmPayment);
